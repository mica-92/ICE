...
n = "PIL19"
exp_data = pd.read_csv (f'D:\Qi-2017\MICA\{n}.csv',names=col_names)
...
### QUE ONDA!!!
disp0 = str(disp[130]) #cuando lo redefino a traves de exp_data[] no encuentra este valor consultar, algo similar pasa cuando sec0
#disp0 = 1.336177
